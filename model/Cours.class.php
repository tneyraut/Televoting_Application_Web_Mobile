...
class Cours extends Model
{
    ...
    public static function supprimerCoursById($id)
    {
        ...
        Questionnaire::supprimerQuestionnairesByCours($id);
        
        User_Groupe::supprimerUserGroupeByGroupeId($cours->groupe_id);
        
        Groupe::supprimerGroupe($cours->groupe_id);
        
        Question_Eleve::supprimerQuestionEleveByCoursID($cours->cours_id);
    ...
    {
        $cours = Cours::getCoursByUser($id);
        
        foreach ($cours as $unCours)
        {
            Questionnaire::supprimerQuestionnairesByCours($unCours->cours_id);
            
            User_Groupe::supprimerUserGroupeByGroupeId($unCours->groupe_id);
            
            Groupe::supprimerGroupe($unCours->groupe_id);
            
            Question_Eleve::supprimerQuestionEleveByCoursID($unCours->cours_id);
        }
    ...
    {
        $cours = Cours::getCoursByName($nom);
        
        Questionnaire::supprimerQuestionnairesByCours($cours->cours_id);
    ...
    {
        $resultat = parent::exec('COURS_BY_ID', array(
            ':cours_id' => $cours_id
        ));
