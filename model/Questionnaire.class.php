...
class Questionnaire extends Model
{
    ...
    {
        Participant::supprimerParticipantsByQuestionnaire($id);
        
        Question::supprimerQuestionsByQuestionnaire($id);
    ...
    public static function supprimerQuestionnairesByCours($id)
    {
        ...
        $questionnaires = Questionnaire::getQuestionnaireByCours($cours->cours_name);
    ...
    public static function miseAJourQuestionnaire($nomQuestionnaire, $nouveauNom, $nouveauMode, $nouveauNomCours, $cours_name, $malus, $pause, $lancee)
    {
        if ($nouveauMode == 'Oui') {
            $nouveauMode = 1;
        }
