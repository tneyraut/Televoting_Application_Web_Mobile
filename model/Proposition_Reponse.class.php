...
class Proposition_Reponse extends Model
{
    ...
    public static function supprimerPropositionReponseByReponse($reponse_id)
    {
        parent::exec('SUPPRIMER_PROPOSITION_REPONSE_BY_REPONSE', array(':reponse_id' => $reponse_id));
    }
