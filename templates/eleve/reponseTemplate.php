...
<body>
    ...
    <section data-role="page">
        ...
        <div data-role="content">
            ...
            <form action="<?php echo $this->bu('eleve', 'reponseCompteurEffectuee', array('cours_name' => str_replace(' ', '_', $cours_name), 'questionnaire_name' => str_replace(' ', '_', $questionnaire_name), 'compteur' => $compteur, 'question_id' => $question->question_id)); ?>" method="post">
                <table>
